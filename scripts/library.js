...
const wallets = {
  ...
  // terra15f9tzfjhy439486tukujs5jn84a5vp55pmz874
  lunaHomework: client.wallet(
    new MnemonicKey({
      mnemonic:
        "inherit screen canoe round grunt tool cereal dilemma mind river apple brain pupil tent heart stairs myself develop jaguar village lunar level cherry basic",
    })
  ),
};
